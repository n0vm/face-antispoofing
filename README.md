...
В данном репозитории представлен код моей дипломной работы, в ходе которой был разработан и реализован новый алгоритм обнаружения [презентационных атак на системы распознавания лиц](https://arxiv.org/abs/2111.11794).
